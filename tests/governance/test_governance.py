...
class TestGovernanceContract(unittest.TestCase):
    ...
    def test_g3_representative_edit_decisions(self):
        ...
        self.assertEqual(decide(build, "AGENTS.md"), "allow")
        self.assertEqual(decide(build, ".opencode/agents/builder.md"), "allow")
        self.assertEqual(decide(build, "docs/project-state.md"), "allow")
        self.assertEqual(decide(build, "tests/governance/test_governance.py"), "allow")
        self.assertEqual(decide(build, ".github/workflows/governance.yml"), "allow")
    ...
    def test_g4_representative_task_shell_decisions(self):
        ...
        self.assertEqual(decide(build_b, TEST_CMD), "allow")
